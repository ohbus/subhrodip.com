...
export const routes: Routes = [
  { path: '', component: HomeComponent, data: { title: 'Subhrodip Search', description: 'Search the portfolio of Subhrodip Mohanta, Software Developer and Cloud Enthusiast.' } },
  { path: 'search', loadComponent: () => import('./components/results/results').then(m => m.ResultsComponent), data: { title: 'Subhrodip Mohanta - Search Results', description: 'General search results for Subhrodip Mohanta.' } },
  ...
  { path: 'go/:slug', loadComponent: () => import('./components/redirect/redirect').then(m => m.RedirectComponent), data: { title: 'Redirecting...', description: 'Redirecting to a specific resource.' } },
  { path: '**', redirectTo: '' }
];
